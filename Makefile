...
ACLOCAL = ${SHELL} /Users/lovewind/desktop/software_testing/gtest-1.7.0/build-aux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /Users/lovewind/desktop/software_testing/gtest-1.7.0/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/lovewind/desktop/software_testing/gtest-1.7.0/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/lovewind/desktop/software_testing/gtest-1.7.0/build-aux/missing --run automake-1.11
AWK = awk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/lovewind/desktop/software_testing/gtest-1.7.0/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 1.7.0
abs_builddir = /Users/lovewind/desktop/software_testing/gtest-1.7.0
abs_srcdir = /Users/lovewind/desktop/software_testing/gtest-1.7.0
abs_top_builddir = /Users/lovewind/desktop/software_testing/gtest-1.7.0
abs_top_srcdir = /Users/lovewind/desktop/software_testing/gtest-1.7.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/lovewind/desktop/software_testing/gtest-1.7.0/build-aux/install-sh
